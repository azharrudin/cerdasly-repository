        ...
        <center class="card-question lay-container-smaller" style="overflow: auto;">
            <div>
                <div class="cps-img-container ui_circular_image-x75" id="imgprofile">
                    <img src="<?= $core->getImgByUsername($_GET["user"]); ?>" height="100" alt="<?= strip_tags($_GET['user']); ?>" loading="lazy" style="border-radius: 50%;max-width: 100px;" />
                    <?php
                ...
                <div id="editinfo" style="display: none;">
                    <div class="form-group" id="group-chg-realname">
                        ...
                        <div class="input-group cps-input-group">
                            ...
                            <input type="email" class="form-control" id="chg-realname" placeholder="Ganti Nama Anda" name="email" value="<?= $core->getRealnameByUsername($_GET["user"]); ?>" style="border-left: none;" />
                        </div>
                ...
                <div id="setting" style="display: none;">
                    <form>
                        <div class="form-group">
                            ...
                            <div class="input-group cps-input-group">
                                <span class="input-group-addon"><span class="bi bi-person-circle"></span></span>
                                <input type="email" class="form-control" id="ui_email" placeholder="Ganti Email Anda" style="border-left: none;" value="<?= $core->getEmailByUsername($_GET['user']) ?>" />
                            </div>
                ...
                <div id="delete" style="display: none;">
                    <form>
                        <div class="form-group">
                            ...
                            <div class="input-group cps-input-group">
                                <span class="input-group-addon"><span class="bi bi-shield-lock"></span></span>
                                <input type="password" class="form-control" id="deletepw" placeholder="Password Anda" name="email" style="border-left: none;" />
                            </div>
                        </div>
                    </form>
