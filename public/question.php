...
<html>
    <head>
        <title><?= strlen($question["title"]) == false ? $question["title"] : substrwords(strip_tags($question["title"]), 10); ?></title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="<?= substrwords(strip_tags($best_answer["answer"]), 30); ?>" name="description"/>
        <meta content="title" name="<?= strlen($question["title"]) == false ? $question["title"] : substrwords(strip_tags($question["title"]), 10); ?>">
