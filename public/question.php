...
<head>
    ...
    <meta content="<?= strlen($question["title"]) == false ? "Pertanyaan tidak ditemukan" : substrwords(strip_tags($question["title"]), 10, true); ?>" name="title">
    ...
    ?>
        ...
        <div class="side-right side-left-height" id="sideright">
            ...
            <div id="kotak-jawab" class="list-card-x mb-2">
                ...
                <input type="submit" class="btn btn-danger btn-sm cps-btn" value="<?= isset($currentanswer['answer']) ? 'edit' : 'jawab'; ?> " onclick="submitanswer()" style="width: 100%;background: #D9543F;" id="answerbutton">
            </div>
            ...
            <div id="answers">
                ...
                ?>
                    ...
                    <div class="lay-mobile-only list-card-x" id="ui_mobile_only_other_question" style="word-wrap: break-word;border-radius: 6px;">
        ...
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6098201334142651" crossorigin="anonymous"></script>
        <!-- Unit Code. A10B0 -->
        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-6098201334142651" data-ad-slot="7867008779" data-ad-format="auto" data-full-width-responsive="true"></ins>
